...
import { getMyRestaurants, getRestaurantOrders, updateOrderStatus } from "@/lib/restaurant-api"
                    ...
                    <CardContent>
                        {restaurants.length > 0 ? (
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                {restaurants.map((restaurant) => (
                                                    <SelectItem key={restaurant._id} value={restaurant._id || "default"}>
                                                        {restaurant.name}
                                                    </SelectItem>
                                                ))}
                                            </SelectContent>
                                        ...
                                        {filteredOrders.length > 0 ? (
                                                                        ...
                                                                        <div className="mt-4 pt-4 border-t">
                                                                            ...
                                                                            <div className="flex flex-wrap gap-2">
                                                                                {getNextStatus(order.status) && (
                                                                                    <Button
                                                                                        onClick={() =>
                                                                                            handleUpdateOrderStatus(order._id, getNextStatus(order.status))
                                                                                        }
                                            ...
                                            <div className="text-center py-12">
                                                ...
                                                <p className="text-sm text-gray-500">
                                                    {orders.length > 0 ? "Try adjusting your search or filters" : "You don't have any orders yet"}
                                                </p>
                                            </div>
                                        )}
                                    </TabsContent>
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-sm text-gray-500 mb-4">You need to create a restaurant before managing orders.</p>
                                <Button
