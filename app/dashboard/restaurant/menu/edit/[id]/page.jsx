...
import { getMenuItemById, updateMenuItem, getMyRestaurants } from "@/lib/restaurant-api"
        ...
        const fetchMenuItem = async () => {
            try {
                ...
                setForm({
                    ...
                    nutritionalInfo: {
                        calories: menuItem.nutritionalInfo?.calories?.toString() || "",
                        protein: menuItem.nutritionalInfo?.protein?.toString() || "",
                        carbs: menuItem.nutritionalInfo?.carbs?.toString() || "",
                        fat: menuItem.nutritionalInfo?.fat?.toString() || "",
                    },
                })
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 p-6 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-lg">Loading menu item details...</p>
                </div>
            </div>
        )
    }
        ...
        <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 p-6">
            <div className="max-w-4xl mx-auto">
                ...
                <Card className="border-none shadow-xl">
                    <CardHeader>
                        <CardTitle className="text-2xl">Edit Menu Item</CardTitle>
                        <CardDescription>Update the details of your menu item below.</CardDescription>
                    </CardHeader>
                    <CardContent>
