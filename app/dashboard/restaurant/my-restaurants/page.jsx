...
import { getMyRestaurants, updateRestaurantAvailability, deleteRestaurant } from "@/lib/restaurant-api"
...
import { Pizza, Plus, Search, Edit, Trash2, MapPin, Phone, Mail, Clock, Store } from "lucide-react"
import {
    AlertDialog,
    AlertDialogAction,
    AlertDialogCancel,
...
export default function MyRestaurantsPage() {
    ...
    const handleToggleAvailability = async (restaurant) => {
        try {
            ...
            // Update local state
            const updatedRestaurants = restaurants.map((r) => (r._id === updatedRestaurant._id ? updatedRestaurant : r))
            setRestaurants(updatedRestaurants)

            toast.success(`${restaurant.name} is now ${updatedRestaurant.isAvailable ? "available" : "unavailable"}`)
        } catch (error) {
    ...
    const handleDeleteRestaurant = async () => {
        ...
        try {
            ...
            // Update local state
            const updatedRestaurants = restaurants.filter((r) => r._id !== restaurantToDelete._id)
            setRestaurants(updatedRestaurants)
                            ...
                            {isLoading ? (
                                                    ...
                                                    <div className="flex justify-between items-center">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <Switch
                                                                ...
                                                                onCheckedChange={() => handleToggleAvailability(restaurant)}
                                                        ...
                                                        <div className="flex gap-2">
                                                            <Button
                                                                ...
                                                                size="sm"
                                                                className="h-8"
                                                                onClick={() => router.push(`/dashboard/restaurant/edit/${restaurant._id}`)}
                                                            >
                                ...
                                <div className="text-center py-12">
                                    ...
                                    {searchQuery ? (
                                        ...
                                        <>
                                            <p className="text-sm text-gray-500 mb-4">You haven't added any restaurants yet.</p>
                                            <Button
                                                onClick={() => router.push("/dashboard/restaurant/create")}
                                                className="bg-orange-500 hover:bg-orange-600"
                                            >
            ...
            <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={handleDeleteRestaurant} className="bg-red-500 hover:bg-red-600">
                            Delete
                        </AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
