  ...
  useEffect(() => {
    if (form.location) {
      console.log(
        ...
        JSON.stringify(form.location, null, 2)
      );
    }
  }, [form.location]);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="border-none shadow-xl">
          <CardHeader>
            ...
            <CardDescription>
              Fill in the details below to create your restaurant. Once
              submitted, it will be reviewed by our team.
            </CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    >
                      <DialogTrigger asChild>
                        <Button className="rounded-l-none" type="button">
                          ...
                          {form.address ? "Change Location" : "Select on Map"}
                        </Button>
                      </DialogTrigger>
