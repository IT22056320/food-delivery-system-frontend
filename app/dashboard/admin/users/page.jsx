    ...
    const fetchUsers = async () => {
      try {
        ...
        const stats = {
          ...
          restaurantOwners: data.filter((u) => u.role === "restaurant_owner")
            .length,
          deliveryPersonnel: data.filter((u) => u.role === "delivery_personnel")
            .length,
  ...
  const getRoleBadge = (role) => {
    switch (role) {
      ...
      case "restaurant_owner":
        return (
          <Badge className="bg-blue-100 text-blue-700">Restaurant Owner</Badge>
        );
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <TabsList>
              ...
              <TabsTrigger value="restaurant_owners">
                Restaurant Owners
              </TabsTrigger>
