        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center">
            <Link href="/" className="flex items-center gap-2">
              <Pizza className={`h-8 w-8 ${isScrolled ? "text-orange-500" : "text-white"}`} />
              <span className={`font-bold text-xl ${isScrolled ? "text-gray-800" : "text-white"}`}>FoodHub</span>
            </Link>
            ...
            <nav className="hidden md:flex items-center gap-8">
              <Link
                href="#restaurants"
                className={`font-medium ${isScrolled ? "text-gray-600 hover:text-orange-500" : "text-white hover:text-orange-200"}`}
              >
                Restaurants
              </Link>
              <Link
