        ...
        <nav className="space-y-1">
          <Button
            ...
            className={`w-full justify-start ${
              activePage === "dashboard" ? "bg-blue-500 hover:bg-blue-600" : ""
            }`}
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activePage === "users" ? "bg-blue-500 hover:bg-blue-600" : ""
            }`}
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activePage === "orders" ? "bg-blue-500 hover:bg-blue-600" : ""
            }`}
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activePage === "settings" ? "bg-blue-500 hover:bg-blue-600" : ""
            }`}
